...
function generateHeader(doc) {
  doc
    ...
    .fillColor("#444444")
    .fontSize(20)
    .text("Clean and Green", 110, 57)
    .fontSize(10)
    .text("Egyptian Ministry of Agriculture", 200, 50, { align: "right" })
    .text("Qena Governorate", 200, 65, { align: "right" })
    .text("The Egyptian Arabic Republic", 200, 80, { align: "right" })
    .moveDown();
}
